...
// This global array holds the quiz questions
const QUIZ = [
{
...
function say(s) {
	console.log.apply(this,arguments); // used in debugging
}
...
function showSummary() {
	...
	// Loop through questions and give visual feedback for right/wrong answers
	for (let i=0; i<QUIZ.length; i++)
	{
		// select green or red box
